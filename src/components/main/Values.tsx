...
const Values: React.FC = () => {
  return (
    <section className="pt-24">
      <div className="flex flex-col justify-center items-center bg-[#F3F3F3] rounded-t-[600px] h-auto py-28 sm:py-64 sm:px-16 w-full sm:px-3 sm:py-40 md:pt-[300px] md:pb-[100px]">
        <Layout />
